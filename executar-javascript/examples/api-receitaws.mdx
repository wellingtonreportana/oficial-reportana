...
1. Em seguida, realizamos a requisição para a API da Receitaws utilizando o **Executar JavaScript**, conforme o código abaixo:
...
1. Em nossa estrutura de automação, caso a requisição falhe, daremos a opção para o cliente consultar o CEP novamente ou sair.

![Resultado da requisição \`Reiceitaws\`](/cnpj4.png)

1. Caso a requisição seja feita com sucesso, os dados referentes ao CNPJ serão informados conforme a mensagem abaixo, com opções de botões para realizar uma nova consulta ou sair.
